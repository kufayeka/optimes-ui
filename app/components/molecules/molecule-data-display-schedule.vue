<template>
    <atoms-atom-data-display-col title="Schedule ID" :value="scheduleData?.id || '-'"/>
    <atoms-atom-data-display-col title="Schedule Category & Status">
        <atoms-atom-base-chip>{{ scheduleData?.schedule_category || '-' }}</atoms-atom-base-chip>
        <span>
