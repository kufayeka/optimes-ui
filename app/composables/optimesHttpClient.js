...
export const apiServices = {
  ...
  putEventProcessUpdateAttributes: ({ body: { notes, scrap_flag, activity_code, material_code, operator_shift, loaded_schedule, machine_operator, supplementary_flag }, params: { eventId }, ...options }) => put(`/event-process-update-attributes/${eventId}`, { notes, scrap_flag, activity_code, material_code, operator_shift, loaded_schedule, machine_operator, supplementary_flag }, options),
  ...
  deleteDeleteScheduleData: ({ params: { schedule_id }, ...options }) => delete(`/delete-schedule-data/${schedule_id}`, options),
